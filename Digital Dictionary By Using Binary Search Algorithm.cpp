...
#include<string.h>
#include<conio.h>	
#include<windows.h>	//for sleep fuction in blinking and loading
#include<fstream>	//for file handling
using namespace std;

void cover() //Name of Project
{
	system("color 71"); // you can also change the color by adding b6 instead of 07
	char x = 175;
	char y = 174;
	char z = 240;
	...
	cout << endl;
	cout << "\n\n\n\n\n\n\n\t\t\tTeam Member: Loem Socheanet (2K19/IT/073) and Ezatullah Amin(2K19/IT/047).";
	for (int n = 0; n < 20; n++)
	{
		cout << ".";
		Sleep(350);
...
void history()
{
	...
	char hist[20];
	int X = 1;
	ifstream file("history.txt", ios::out); //This datatype use for reprsenting the input file and opening a file for writing
	cout << "\t\t\t\t\t\tHistory of last searches is:";
	while (!file.eof()) //Checking whether our file is End Of File or not
	{
		file >> hist;
		cout << "\n\t\t\t\t\t\t" << X++ << "-" << " " << hist;
	}
...
void load()
{
	...
	for (int i = 0; i <= 99; i++)
	{
		cout << "\t\t\t\t\t\t\t " << i << "%\r";    //"\r" is Carriage Return which mean move cursor to the begining whithout advancing the next line.
		Sleep(80);
	}
	system("cls");
...
int main() {
	...
	cover();
	system("color 71");
	ofstream file("history.txt", ios::trunc);//This data type represents the output file stream and is used to 
	//create files and to write information to files 
	//If the file already exists, its contents will be truncated before opening the file. (ios:: trunc)
...
menue:
	...
	{"analogue", " n. Analogue is a conventional method of transmitting data. Standard landline telephones use analogue technology. It is distinct from digital technology, which provides for greater quality and speed of data transmission." },
	...
	{"attachment","n. An attachment is a document sent with an email message. Many types of files can be sent this way (e.g. Word documents, PDFs, Excel files, JPEGs)"},
...
{"bandwidth", "n. Bandwidth refers to the maximum amount of data that can travel a communications path in a given time, usually measured in seconds."},
...
{"bit","n. A bit (short for binary digit) is the smallest unit of measurement in computing. 8 bits make up 1 byte."},
...
{"bluetooth", "n. Bluetooth is a wireless communications technology intended to replace cables. It allows short-range connections between two or more Bluetooth-compatible devices such as mobile phones, tablets, headsets or medical equipment."},
...
{"bookmark","n. A bookmark is a saved link to a particular Web page. Microsoft Internet Explorer denotes bookmarks as (favourites)."},
{"boorish"," adj. Rude."},
{"boot","n. To boot (or re-boot) is to load and initialise the operating system on a computer. Think of it as starting up your computer. In Windows you can use the key combination CTRL and ALT and DEL as a (soft) boot. This means restarting the computer rather than turning it completely off and on again, which could cause damage to your computer's hard disk under some circumstances."},
...
{"broadband","n. Broadband is a type of communications technology whereby a single wire can carry more than one type of signal at once; for example, audio and video. Cable TV is one technology that uses broadband data transmission."},
...
{"browser","n. A software program that allows you to surf the web. Popular web browsers include Google Chrome, Mozilla Firefox, Microsoft Edge and Internet Explorer."},
...
{"chip","n. A chip is a microprocessor that performs many functions and calculations that make your computer run. Your computer's chip is also referred to as the CPU (Central Processing Unit) or the processor."},
...
{"compression"," n. Compression is the reduction of the size of a file. Compressed files take up less memory and can be downloaded or sent over the Internet more quickly."},
...
{"cookie","n. A piece of code or data created by a web server and stored on a user's computer. It is used to keep track of the user's usage patterns and preferences."},
...
{"cpu","n. The central processing unit (CPU) is the brains behind your computer. The CPU is responsible for performing calculations and tasks that make programs work. The higher the speed of a CPU, the faster the CPU undertakes the calculations and tasks."},
...
{"cybercrime","n. Cybercrime is any type of illegal activity that is undertaken (or relies heavily) on a computer. There are thousands of types of cybercrime, including network intrusions, identity theft and the spreading of computer viruses."},
{"cybersecurity","n. Cybersecurity refers to measures designed to protect your computer, device or network from cybercrime. This involves preventing unintended and unauthorised access, change and damage."},
...
{"domain","n. A domain is a set of computers on a network that are managed as a unit."},
{"download", "n. Downloading is the method by which users access and save or (pull down) software or other files to their own computers from a remote computer via the Internet."},
...
{"email", "n. Email or electronic mail is a way of sending messages over the internet. Popular email programs include Outlook, Mozilla Thunderbird, Gmail and Yahoo Mail."},
...
{"encription","n. Encryption is the process of converting electronic data to an unrecognisable or encrypted form, one that cannot be easily understood by unauthorised parties."},
...
{"ethernet", "n. Ethernet is the most common way of connecting computers on a network with a wired connection. It is a type of local area network (LAN) technology, providing a simple interface for connecting multiple devices."},
...
{"finite","adj.Limited."},
{"firewall", "n. A firewall is a barrier that acts as a security system to protect trusted computer systems and networks from outside connections and untrusted networks, such as the Internet."},
...
{"intranet","An intranet is basically a private, internal internet specific to an organisation or group"},
...
{"megahertz","Megahertz is the unit used to measure the speed of a computer's processor (e.g. 2.8Ghz)"},
...
{"pmm","Pages per minute (PPM) generally refers to the speed of a printer."},
...
{"processor","The processor is the brains of your computer. It is responsible for performing calculations and tasks that make programs work. The faster the processor, the faster the computer works."},
...
{"protocol","n. A protocol is a standard or set of rules that computers and other devices use when communicating with one another" },
...
{"resolution","Resolution refers to the number of distinct pixels that make up the display on a computer monitor. It is denoted in DPI (dots per inch). The higher the resolution, the finer and smoother the images appear when displayed at a given size."},
...
{"rom","ROM stands for read-only memory. It is the part of a computer's memory that cannot be changed by a user. The contents of ROM remain even when the computer is turned off."},
...
{"sass","SAAS stands for software as a service. It is a software distribution model whereby software applications are centrally hosted and licensed on a subscription basis."},
...
{"seo","SEO, or search engine optimisation, is the practice of making adjustments to certain aspects of a website in an effort to improve its ranking on search engines."},
...
{"server","A server is a computer that handles requests for data, email, file transfers, and other network services from other computers"},
...
{"ssl","SSL, or secure sockets layer, is a protocol that allows Internet users to send encrypted messages across the Internet. It is generally used when transmitting confidential information (e.g. personal data or credit card details). A web address that begins with (https) indicates that an SSL connection is in use."},
...
{"url","A URL (unique resource locator) or web address is the string of characters you type into a browser to access a particular website or other resource on the Internet. (eg. http://www.ourcommunity.com.au )"},
...
{"utmosts","adj. situated at the farthest or most distant"},
//*******************VVVVVVVVVVVVVVV
...
{"virus","A virus is a piece of programming code inserted into other programming to cause damage. Viruses can be sent in many forms but are often transmitted via email messages that, when opened, may erase data or cause damage to your hard disk. Some viruses are able to enter your email system and send themselves to other people in your list of contacts."},
...
{"wavelet"," n. A ripple."},
{"waxen"," adj. made of or covered with wax." },
...
{"wep","Wired equivalent privacy (WEP) is a security protocol used in wi-fi networks. It is designed to provide a wireless local area network (LAN) with a level of security similar to that of a regular wired LAN. WEP-secured networks are usually protected by passwords. (See also WAP.)"},
...
{"wpa","Wi-Fi protected access (WPA) is a security protocol used in wi-fi networks. It is an improvement on WEP because it offers greater protection through more sophisticated data encryption."},
...
{"zip","To zip files is to archive and compress them into one file of smaller size using a program such as WinZip. It's a handy way to make files smaller before sending them via email."},
{"zodiac"," n. An imaginary belt encircling the heavens within which are the larger planets."},
{"zoo"," n. afacility with usually indoor and outdoor settings where living, typically wild animals are kept especially for public exhibition."}
		};
		////****Initailize the low,high and mid value:*****/////
		int low, high, mid;
		i = 0;
		low = 0;
		high = 4856;
		...
		/////***Taking word to input***////
		cin >> word;
		// file input
		file << word << '\n';
		cout << "\n\n\n\n\n\t\t\t\t"; search();

		/////***** Logic of Binary Search Algorithm*****///////
		while (low <= high) {

			if (strcmp(word, word1[mid][i]) == 0) {
				cout << "\n\n\n\n\n\n\n\n\n\n\n__________________________________________________________________________________________________________________________";
				cout << "\n\n\n\t\t\t\t\t\t\tRESULT";
				cout << "\n\t\t\t\t\t\t\t______\n\n\n\n\n";
				cout << "\t\t\t\t  " << word << ":" << word1[mid][1] << "\n";
				cout << "\n\n__________________________________________________________________________________________________________________________";
				cout << "\t\t\t\tPress ENTER to continue";
				_getch();
				goto menue;
			...
			else if (strcmp(word, word1[mid][i]) > 0) {
				cout << "H\t";
				low = mid + 1;
				mid = (low + high) / 2;
			}
		...
		//////***** In case there is not matched with any word in this***///
		if (low > high) {
			cout << "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n__________________________________________________________________________________________________________________________";
